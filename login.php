<!--A Ivan no le va el require, hay que cambiar el codigo de configuracion y misfunciones-->
<?php
...
$resultado_consulta = $mysqli ->query ("SELECT * FROM usuario WHERE usuario = '$usuario_nombre' ");
